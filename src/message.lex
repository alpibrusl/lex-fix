...
type FixMessage = { fields :: List[field.FixField] }
...
fn header(mt :: Str, sender_id :: Str, target_id :: Str, seq_num_val :: Str, timestamp :: Str) -> List[field.FixField] {
  [{ tag: tag.begin_string(), value: "FIX.4.4" }, { tag: tag.msg_type(), value: mt }, { tag: tag.sender_comp_id(), value: sender_id }, { tag: tag.target_comp_id(), value: target_id }, { tag: tag.msg_seq_num(), value: seq_num_val }, { tag: tag.sending_time(), value: timestamp }]
}
