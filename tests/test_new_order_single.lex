...
fn sample_nos() -> nos.NewOrderSingle {
  { cl_ord_id: "ORD-001", symbol: "MSFT", side: Buy(()), order_qty: 100, ord_type: Limit(()), price: Some("125.50"), time_in_force: Day(()), transact_time: "20260527-09:30:00.000", sender_comp_id: "ALGO01", target_comp_id: "EXCH01", account: None }
}
...
fn suite() -> List[Result[Unit, Str]] {
  [test_to_fix_message_msg_type(), test_to_fix_message_symbol(), test_to_fix_message_side(), test_to_fix_message_price(), test_to_fix_message_no_account(), test_roundtrip_qty()]
}
