...
fn suite() -> List[Result[Unit, Str]] {
  [test_side_to_str(), test_side_from_str_buy(), test_side_from_str_unknown(), test_ord_type_roundtrip(), test_ord_type_requires_price_limit(), test_ord_type_requires_price_market(), test_tif_roundtrip(), test_exec_type_roundtrip(), test_ord_status_roundtrip(), test_cxl_rej_reason_roundtrip(), test_cxl_rej_reason_unknown(), test_cxl_rej_reason_all_variants(), test_cxl_rej_response_to_roundtrip(), test_cxl_rej_response_to_unknown()]
}
